...
if __name__ == '__main__':
    ...
    try:
        ...
        phase_2.fact_HDI.get_df().to_sql("staging_hdi", con=db.sql_engine, if_exists='replace', index_label="hdi_id")
        ...
        phase_2.fact_HDI.get_csv()

        db.grant_permit(["dim_country", "dim_country_record", "dim_date", "dim_event", "dim_education",
                        "dim_health", "dim_life_quality", "dim_population", "staging_hdi"], "lzou041")
